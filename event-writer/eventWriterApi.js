...
const productCartSchema = require('./schemas/product-cart-schema.json')
...
const productCartSchemaId = makeSchemaId(productCartSchema)
...
ajv.addSchema(productCartSchema, productCartSchemaId)
